...
**VMs déployées (3 max):**
1. **OPNSense-S1** (192.168.30.1) - Pare-feu/Router principal
...
* **WAN:** Interface publique pour VPN
**VMs déployées (3 max):**
1. **OPNSense-S2** (192.168.130.1) - Pare-feu/Router secondaire
    * Interface WAN: IP publique
...
* **Tunnel Principal:** 10.0.0.0/30
    * OPNSense-S1: 10.0.0.1
    * OPNSense-S2: 10.0.0.2
...
* **Site 2:** OPNSense-S2 comme DNS secondaire (192.168.110.1)
    * Zone interne: site2.local
    * Forwarder vers OPNSense-S1 pour résolution complète
...
* **Sources de logs:**
    * OPNSense-S1 et OPNSense-S2: logs firewall, VPN
...
* Configuration OPNSense standardisée
...
* **DNS:** Hiérarchie OPNSense-S1 → OPNSense-S2
